...
function total() {
    ...
    var totalgrade = parseFloat(w) + parseFloat(x) + parseFloat(y) + parseFloat(z);
    ...
    if (percentage < 40 ) {
        ...
        ol = "PASS";
            ...
            document.getElementById('grill').innerHTML = `Your total grade is ${totalgrade}. Your percentage is ${percentage}%. Your grade is ${grade}. You are ${ol}.`;
